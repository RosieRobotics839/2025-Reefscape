...
public class PIDController implements Sendable, AutoCloseable {
  ...
  DoublePublisher nt_err, nt_verr, nt_set, nt_fb, nt_output, nt_p, nt_i, nt_d, nt_imax, nt_imin, nt_tol_p, nt_tol_v;
  BooleanPublisher nt_iscont;
  NTDouble nt_scale;
  NTDouble nt_kp, nt_ki, nt_kd;
  double m_ntscale;
  ...
  public void setNTScale(double scalar){
    nt_scale.set(scalar);
    m_ntscale = scalar;
  }
  ...
  public void setIntegratorRange(double minimumIntegral, double maximumIntegral) {
    ...
    if (table != null){
      nt_imax.set(m_maximumIntegral);
      nt_imin.set(m_minimumIntegral);
    }
  }
  ...
  public void setTolerance(double positionTolerance) {
    ...
    if (table != null){
      nt_tol_p.set(m_ntscale*positionTolerance);
    }
  }
  ...
  public void setTolerance(double positionTolerance, double velocityTolerance) {
    ...
    if (table != null){
      nt_tol_p.set(m_ntscale*positionTolerance);
      nt_tol_v.set(m_ntscale*velocityTolerance);
    }
  }

  public double getEffortP() {
    return m_kp * m_positionError;
  }

  public double getEffortI() {
    return m_ki * m_totalError;
  }

  public double getEffortD() {
