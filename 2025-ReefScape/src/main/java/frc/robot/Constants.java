...
public final class Constants {
  ...
  public static class ArmConstants {
    ...
    public static double kAngleMaxDZ = Units.degreesToRadians(NTDouble.create(72.0,"Arm/DZ/kAngleMax",(val)->kAngleMaxDZ=Units.degreesToRadians(val))); // The Max Angle in degrees for the Arm while it is in the Danger Zone (dz)
